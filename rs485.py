...
class Mqtt:
   ...
   def upload(self, msg):
       ...
       mydb = mysql.connector.connect(
          ...
          user="root",
          password="",
          database="iot_frimware"
       )
       mycursor = mydb.cursor()
       sql = "INSERT INTO data(Current) VALUES(%s)"
       val = (mqtt_msg,)
